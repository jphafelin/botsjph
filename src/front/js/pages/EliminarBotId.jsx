...
export const EliminarBotId = () => {
  ...
  const grabar = () => {
    ...
    var raw = JSON.stringify({
      "codBot": `${csvData.codBot}`,
      "descripcionBot": `${csvData.descripcionBot}`,
      "tipoEjecucion": `${csvData.tipoEjecucion}`,
      "nombreEmpresa": `${csvData.nombreEmpresa}`,
      "observacion": `${csvData.observacion}`,
      "rutaCarpetasBot": `${csvData.rutaCarpetasBot}`,
      "inicio": `${csvData.inicio}`,
      "termino": `${csvData.termino}`,
