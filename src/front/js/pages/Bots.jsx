    ...
    <div className="justify-content-center">
      ...
      <div id="formulario" className="col col-lg-3 col-md-12   text-center p-5 border border-3 border-dark bg-light">
        <div className="row justify-content-center mb-3">
          <button id="btn-ingresar" className="col-10 justify border border-3 border-dark text-light" onClick={IngresarBot=> navigate("/ingresar_bot")}>I N G R E S A R</button>
        </div>
        <div className="row justify-content-center mb-3">
          <button id="btn-eliminar" className="col-10 justify border border-3 border-dark text-light" onClick={EliminarEmpresa=> navigate("/eliminar_bot")}>E L I M I N A R</button>
        </div>
        <div className="row justify-content-center mb-3">
          <button id="btn-modificar" className="col-10 justify border border-3 border-dark" onClick={ModificarEmpresa=> navigate("/modificar_bot")}><b>M O D I F I C A R</b></button>
        </div>
        <div className="row justify-content-center mb-3">
          <button id="btn-consultar" className="col-10 justify border border-3 border-dark text-light" onClick={ConsultarEmpresa=> navigate("/consultar_bot")}>C O N S U L T A R</button>
        </div>
        <div className="row justify-content-center">
          <button id="btn-reporte" className="col-10 justify border border-3 border-dark" onClick={ReporteEmpresa=> navigate("/reporte_bot")}><b>R E P O R T E</b></button>
        </div>
